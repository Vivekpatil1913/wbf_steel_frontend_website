    ...
    return (
        <>
            <div class="container-fluid mb-5">
                ...
                <div class="row mt-3">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center align-items-left p-5 text-left p-0 m-0 colum_backcolor p-0 m-0">

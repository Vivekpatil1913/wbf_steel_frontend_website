            ...
            <Col lg={8} md={8} sm={12} className="mt-5">
              <div className="paraAbout1">
                <p>
                  ...
                  delivering precise, reliable,and cost-effective solutions.With
                  a skilled team and advanced tools,we ensure quality and
                  on-time project delivery while maintaining transparency and
                  safety.Our expertise spans steel detailing, connection design,
                  BIM,rebar detailing, and pre-engineered metal buildings for
                  residential,industrial, and commercial sectors. Guided by OSHA
                  standards and global codes,we continue to build lasting client
                  relationships through innovation, integrity, and excellence.
                </p>
              </div>
            </Col>
